"""Conversation support for Cloudflare AI Gateway."""
...
async def async_setup_entry(
    ...
    for subentry in config_entry.subentries.values():
        ...
        async_add_entities(
            [CloudflareAIGatewayConversationEntity(config_entry, subentry)],
            config_subentry_id=subentry.subentry_id,
        )


class CloudflareAIGatewayConversationEntity(
    conversation.ConversationEntity,
    conversation.AbstractConversationAgent,
    CloudflareAIGatewayBaseLLMEntity,
):
    """Cloudflare AI Gateway conversation agent."""
